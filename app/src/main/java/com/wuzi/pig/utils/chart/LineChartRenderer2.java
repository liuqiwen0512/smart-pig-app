...
public class LineChartRenderer2 extends LineRadarRenderer {
    ...
    public LineChartRenderer2(LineDataProvider chart, ChartAnimator animator,
    ...
    public LineChartRenderer2(ChartAnimator animator, ViewPortHandler viewPortHandler) {
        super(animator, viewPortHandler);
    }
