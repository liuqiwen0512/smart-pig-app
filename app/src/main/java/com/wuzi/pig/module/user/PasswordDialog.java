...
public class PasswordDialog extends BaseDialogFragment<PasswordPresenter> implements PasswordContract.IView {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mPhoneValueView.setText(StringUtils.nullToString(LoginManager.getUserName()));
    }
    ...
    public void onClickView(View v) {
        switch (v.getId()) {
            ...
            case R.id.submit:{
                ...
                showError(null);
                mLoadingDialog.show();
                mPresenter.updateByVerificationCode(password, verificationCode, phone);
                break;
            }
        }
    }
    ...
    @Override
    public void performSuccress(Object entity) {
        mLoadingDialog.hide();
        showError(null);
    ...
    public void performError(ResponseException error, int fromTag) {
        mLoadingDialog.hide();
        if (fromTag == PasswordContract.TAG_ERROR_PASSWORD) {
    ...
    private static class HandlerImpl extends Handler {
        ...
        private WeakReference<PasswordDialog> mDialogWeakRef;

        public HandlerImpl(PasswordDialog dialog) {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case WHAT_TIMER:{
                    PasswordDialog dialog = mDialogWeakRef.get();
